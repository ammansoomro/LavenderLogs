...
$query = "SELECT id, title, category_id FROM posts WHERE author_id = $current_user_id ORDER BY posts.title ASC";
                    ...
                    <tbody>
                        <?php while ($post = mysqli_fetch_assoc($posts)) : ?>
                            ...
                            <tr>
                                ...
                                <td><a href="<?= ROOT_URL ?>admin/delete-post.php?id=<?= $post['id'] ?>" class="btn sm delete">Delete</a></td>
                            </tr>
                        <?php endwhile ?>
                    </tbody>
                </table>
