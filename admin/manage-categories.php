                    ...
                    <tbody>
                        <?php while ($category = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <td><a href="<?= ROOT_URL ?>admin/edit-category.php?id=<?= $category['id'] ?>" class="btn sm edit">Edit</a></td>
                                <td><a href="<?= ROOT_URL ?>admin/delete-category.php?id=<?= $category['id'] ?>" class="btn sm delete">Delete</a></td>
                            </tr>
                        <?php endwhile ?>
                    </tbody>
                </table>
